export const AUTH_COOKIE = 'space_mission_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@space-mission-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@space-mission-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@space-mission-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
