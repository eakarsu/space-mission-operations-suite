...
const featureSeeds = [
  ['records', 'Cases', 'Cases operating queue', 'Public Lead', 'Review and assign next action'],
  ['incidents', 'Incidents', 'Incidents operating queue', 'Public Lead', 'Review and assign next action'],
  ['units', 'Units', 'Units operating queue', 'Public Lead', 'Review and assign next action'],
  ['schedules', 'Schedules', 'Schedules operating queue', 'Public Lead', 'Review and assign next action'],
  ['evidence', 'Evidence', 'Evidence operating queue', 'Operations Lead', 'Review and assign next action'],
  ...
  ['alerts', 'Alerts', 'Alerts operating queue', 'Governance Lead', 'Review and assign next action'],
