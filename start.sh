...
PORT="${PORT:-4940}"
DB_NAME="${PGDATABASE:-space_mission_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Space Mission Operations Suite"
echo "======================================="
echo
...
echo "Starting space mission operations suite frontend on http://localhost:$PORT"
echo "Login: admin@space-mission-operations.local / admin123"
